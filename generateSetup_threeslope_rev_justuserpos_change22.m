function [gainOverNoisedB,R,pilotIndexCF,pilotIndexSC,UEpositions,distancesUE] = generateSetup_threeslope_rev_justuserpos_change22(L,K,N,tau_p,nbrOfSetups,p,APpositions,UEpositions)
