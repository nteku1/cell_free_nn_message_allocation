function [gainOverNoisedB,R,pilotIndexCF,pilotIndexSC,APpositions,UEpositions,distancesUE] = generateSetup_threeslope_rev(L,K,N,tau_p,nbrOfSetups,p)
...
%10 APs     
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%APpositions = (50:50:500) + 1i*(50:50:500);
% 15 APs   APpositions = (50:25:400) + 1i*(50:25:400); %15
%20 APs  APpositions = (50:18:400) + 1i*(50:18:400); %15
% 5 APs      APpositions = (50:75:400) + 1i*(50:75:400); %15
%25 APs       APpositions = (50:15:410) + 1i*(50:15:410); %15
