...
def update(
    ...
    return critic_value,critic_loss
...
for ep in range(total_episodes):
    ...
    #while indexxx < 15:
        ...
        resulting_alphas,nn_latency = update(un_dB_sinr, copy_of_GAINS_co)
        actions = []
...
plt.ylabel("CDF")
plt.legend(['Proposed Method', 'Uniform Allocation', 'Greedy Allocation','Interior Point'])
plt.show()
