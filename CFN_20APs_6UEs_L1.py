...
file1 = open('BPL3_1000m_VER15_20AP_6UE_SHAD_Hmat_scenario3_10APs_Multi_2_users_FUNFINALACTUREG_complex_50000_7_28_ExtendingTesting_ver62.txt', 'r')
lines = file1.readlines()


num_APs = 20 #20 #20 #25 #20#10
    ...
    #while indexxx < 15:
      ...
      #state, reward, done, info = env.step(action)
       ...
       '''
        ...
        if indexxx == 3006:#7008:#5004:#3006:#5004:#1200:#2400:#14526:
          stop_now = 1
          break
...
file2 = open('BPL3_1000m_VER15_20AP_6UE_SHAD_Hmat_scenario3_10APs_Multi_2_users_FUNFINALACTUREG_complex_part2_7_28_ExtendingTesting_ver62.txt', 'r')
