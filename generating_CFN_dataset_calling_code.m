...
fileID3 = fopen('3_23_vsddbbbbALL_SHAD_1000meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD.txt','w');
fileID4 = fopen('3_23_vsddbbbbALL_SHAD_1000meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD_part2.txt','w');



% fileID3 = fopen('vNEW_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_20AP_6_UE_50000SHAD.txt','w');
% fileID4 = fopen('vNEW_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_20AP_6_UE_50000SHAD_part2.txt','w');



% fileID3 = fopen('VER21_MOBILITY_UES_REDO_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD.txt','w');
% fileID4 = fopen('VER21_MOBILITY_UES_RREDO_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD_part2.txt','w');
% 

% fileID3 = fopen('EFBACTUAL_RREDO_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD.txt','w');
% fileID4 = fopen('EFBACTUAL_RREDO_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD_part2.txt','w');


% fileID3 = fopen('EFBACTUAL_RREDO_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD.txt','w');
% fileID4 = fopen('EFBACTUAL_RREDO_100meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD_part2.txt','w');

% fileID3 = fopen('BACTUAL_RREDO_300meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD.txt','w');
% fileID4 = fopen('BACTUAL_RREDO_300meters_PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_10AP_6_UE_50000SHAD_part2.txt','w');

% fileID3 = fopen('PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_30AP_10_UE_50000SHAD.txt','w');
% fileID4 = fopen('PRETTY_PLS_VER551_MULTIPLE_PATHS_LARGE_VER1_30AP_10_UE_50000SHAD_part2.txt','w');
% fileID3 = fopen('VER151_MULTIPLE_PATHS_LARGE_VER1_30AP_10_UE_50000SHAD.txt','w');
% fileID4 = fopen('VER151_MULTIPLE_PATHS_LARGE_VER1_30AP_10_UE_50000SHAD_part2.txt','w');
% fileID3 = fopen('VER50_MULTIPLE_PATHS_LARGE_VER1_100AP_40_UE_50000SHAD.txt','w');
% fileID4 = fopen('VER50_MULTIPLE_PATHS_LARGE_VER1_100AP_40_UE_50000SHAD_part2.txt','w');
% fileID3 = fopen('VER20_MULTIPLE_PATHS_VER1_10AP_6_UE_50000SHAD.txt','w');
% fileID4 = fopen('VER20_MULTIPLE_PATHS_VER1_10AP_6_UE_50000SHAD_part2.txt','w');
% fileID3 = fopen('MULTIPLE_PATHS_VER1_10AP_6_UE_50000SHAD.txt','w');
% fileID4 = fopen('MULTIPLE_PATHS_VER1_10AP_6_UE_50000SHAD_part2.txt','w');

% % % % % % fileID3 = fopen('VER11_2023_10AP_20_UE_PL3_50000SHAD.txt','w');
% % % % % % fileID4 = fopen('VER11_2023_10AP_20_UE_PL3_50000SHAD_part2.txt','w');

% fileID3 = fopen('VER17_2023_PL3_500000SHAD.txt','w');
% fileID4 = fopen('VER17_2023_PL3_500000SHAD_part2.txt','w');

% fileID3 = fopen('VER11_12_16_10_AP_3_UE_ENV2.txt','w');
% fileID4 = fopen('VER11_12_16_10_AP_3_UE_ENV2_part2.txt','w');
...
for iiii = 1:51001%501000%51000%210000
...
%         [gainOverNoisedB,R,pilotIndexCF,pilotIndexSC,APpositions,UEpositions] = generateSetup_threeslope_rev(L,K,N,tau_p,1,p);
          [gainOverNoisedB,R,pilotIndexCF,pilotIndexSC,APpositions,UEpositions] = generateSetup_threeslope_rev_ALLSHAD(L,K,N,tau_p,1,p);
    else
         [gainOverNoisedB,R,pilotIndexCF,pilotIndexSC] = generateSetup_threeslope_rev_justuserpos_change22_ALLSHAD(L,K,N,tau_p,1,p,APpositions,UEpositions);
...
%30 APs
% fprintf(fileID3,'%.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f\n',...
%   real(H_AP(1,jlock)), imag(H_AP(1,jlock)),real(H_AP(2,jlock)),imag(H_AP(2,jlock)),real(H_AP(3,jlock)), imag(H_AP(3,jlock)),...
%   real(H_AP(4,jlock)), imag(H_AP(4,jlock)),real(H_AP(5,jlock)),imag(H_AP(5,jlock)),real(H_AP(6,jlock)), imag(H_AP(6,jlock)),...
%   real(H_AP(7,jlock)), imag(H_AP(7,jlock)),real(H_AP(8,jlock)),imag(H_AP(8,jlock)),real(H_AP(9,jlock)), imag(H_AP(9,jlock)),...
%   real(H_AP(10,jlock)), imag(H_AP(10,jlock)),real(H_AP(11,jlock)), imag(H_AP(11,jlock)),real(H_AP(12,jlock)), imag(H_AP(12,jlock)),...
...
% fprintf(fileID4,'%.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f\n',...
%           real(H_AP(1,block)), imag(H_AP(1,block)),real(H_AP(2,block)),imag(H_AP(2,block)),real(H_AP(3,block)), imag(H_AP(3,block)),...
%           real(H_AP(4,block)), imag(H_AP(4,block)),real(H_AP(5,block)),imag(H_AP(5,block)),real(H_AP(6,block)), imag(H_AP(6,block)),...
%           real(H_AP(7,block)), imag(H_AP(7,block)),real(H_AP(8,block)),imag(H_AP(8,block)),real(H_AP(9,block)), imag(H_AP(9,block)),...
%           real(H_AP(10,block)), imag(H_AP(10,block)),real(H_AP(11,jlock)), imag(H_AP(11,jlock)),real(H_AP(12,jlock)), imag(H_AP(12,jlock)),...
